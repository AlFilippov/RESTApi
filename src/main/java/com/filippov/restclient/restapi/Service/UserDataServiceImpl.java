...
public class UserDataServiceImpl implements UserDataService {
    private final UserDataListRepository userDataListRepository;

    public UserDataServiceImpl(UserDataListRepository userDataListRepository) {
        this.userDataListRepository = userDataListRepository;
    }
